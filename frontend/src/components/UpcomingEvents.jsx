...
const Events = () => {
    ...
    return (
        <div className='flex flex-col items-center gap-4 my-16 text-[#262626] md:mx-10'>
            <h1 className='text-3xl font-medium'>Our Upcoming Events</h1>
            <p className='sm:w-1/3 text-center text-sm'>Simply browse through the extensive list of our ongoings .</p>
            ...
            <button onClick={() => { navigate('/what-we-do'); scrollTo(0, 0) }} className='bg-[#EAEFFF] text-gray-600 px-12 py-3 rounded-full mt-10'>more</button>
        </div>
