          ...
          <>
            <DisclosureButton className="fixed z-40 flex items-center justify-center transition duration-300 bg-indigo-500 rounded-full shadow-lg right-5 bottom-5 w-14 h-14 focus:outline-none hover:bg-indigo-600 focus:bg-indigo-600 ease">
              ...
              <Transition
                ...
                enterFrom="opacity-10 -rotate-45 scale-75"
                leave="transition duration-100 transform ease"
                leaveTo="opacity-10 -rotate-45"
              >
                <svg
            ...
            >
              <DisclosurePanel className=" flex flex-col  overflow-hidden left-0 h-full w-full sm:w-[350px] min-h-[250px] sm:h-[600px] border border-gray-300 dark:border-gray-800 bg-white shadow-2xl rounded-md sm:max-h-[calc(100vh-120px)]">
                <div className="flex flex-col items-center justify-center h-32 p-5 bg-indigo-600">
                  <h3 className="text-lg text-white">Want to HAPSCALE!!</h3>
                ...
                <div className="flex-grow h-full p-6 overflow-auto bg-gray-50 ">
                  {!isSubmitSuccessful && (
                    <form onSubmit={handleSubmit(onSubmit)} noValidate>
                      <input
                        type="hidden"
                        value="959b8aa4-7eb3-4ff8-bf84-62b72ee855a8"
                        {...register("apikey")}
                      />
                      <input
                        type="hidden"
                        value={`${userName} sent a message from HAPSCALE`}
                        {...register("subject")}
                      />
                      <input
                        type="hidden"
                        value="HAPSCALE Template"
                        {...register("from_name")}
                      />
                      <input
                        type="checkbox"
                      ...
                      <div className="mb-4">
                        <label
                          htmlFor="full_name"
                          className="block mb-2 text-sm text-gray-600 dark:text-gray-900"
                        >
                          Full Name
                        </label>
                        <input
                      ...
                      <div className="mb-4">
                        <label
                          htmlFor="message"
                          className="block mb-2 text-sm text-gray-600 dark:text-gray-700"
                        >
                          Your Message
                        </label>
