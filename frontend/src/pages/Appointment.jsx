        ...
        <div>
            ...
            <div className='flex flex-col sm:flex-row gap-4 pt-20'>
                ...
                <div className='flex-1 border border-[#ADADAD] rounded-lg p-8 py-7 bg-white mx-2 sm:mx-0 mt-[-80px] sm:mt-0'>
                    ...
                    <p className='text-gray-600 font-medium mt-4'>Ticket fee: <span className='text-gray-800'>{currencySymbol}{docInfo.fees}</span> </p>
                </div>
            </div>
            ...
            <div className='sm:ml-72 sm:pl-4 mt-8 font-medium text-[#565656]'>
                ...
                <button onClick={bookAppointment} className='bg-primary text-white text-sm font-light px-20 py-3 rounded-full my-6'>Book your tickets NOW!!!</button>
            </div>
